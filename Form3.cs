...
namespace debugger
{
    public partial class Form3 : Form
    {
        ...
        public void displayreportd()
        {
            ...
            cmd.CommandText = "Select Id AS ID,REPORT_NAME AS NAME,REPORTER_NAME AS REPORTER,TO_USER,GIT_SOURCE AS SOURCE,ADDITIONAL_INFORMATION AS INFO from REPORT Where TO_USER = '" + get_name() + "' ORDER BY Id DESC";
            cmd.ExecuteNonQuery();
